...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR blue][B]SEA6ULL[/B][/COLOR]Wizard'
BUILDERNAME = 'SEA6ULL'
EXCLUDES = [ADDON_ID, 'repository.sea6ullwizard']
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]SEA6ULL[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing SEA6ULL.'
...
REPOID = 'repository.sea6ullwizard'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR blue][B]SEA6ULL[/B][/COLOR]Wizard'
